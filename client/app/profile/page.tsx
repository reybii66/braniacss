  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        ...
        <div className="overflow-visible rounded-sm border border-stroke bg-white dark:bg-slate-700 shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-32 w-56 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <br></br><br></br>
            ...
            <div className="mt-4  grid grid-cols-2 gap-4 mx-4">
              ...
              <div>
              <label className="place-content-start">FIRST NAME</label>
              <Input type="text" placeholder="First Name" />
              </div>
