			...
			<div style={{
				...
				<center>
					...
					<div className="justify-center inline-block max-w-lg text-center">
						...
						<h1 className={title({ color: "violet" })}>Brainiacs&nbsp;</h1>
						<br />
						{/* <h1 className={title()}>
					where bright minds thrive through
						...
						<Button radius="full" onClick={() => router.push('/signmodal')} color="primary" variant="bordered" className=" font-serif text-base hover:bg-slate-400">
							SignIn
						</Button>&nbsp;&nbsp;&nbsp;
						<Button radius="full" onClick={() => router.push('/studentregister')} color="primary" variant="bordered" className=" font-serif text-base hover:bg-slate-400">
							Register
						</Button>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
						...
						<div className="lg:pl-[100px] flex items-center">
							<div className="data w-full">
								<h2
									className="font-manrope font-bold text-4xl lg:text-5xl dark:text-white text-black mb-9 max-lg:text-center relative">
									About
									Us </h2>
								<p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
								Brainiacs revolutionizes education with peer-to-peer tutoring and personalized support. 
								Our platform fosters collaboration, offering diverse perspectives and resources. 
								With an intuitive interface, we connect students for tailored learning experiences, empowering success in the digital age.
								</p>
							</div>
						</div>
					</div>
			...
			<section className="bg-white dark:bg-gray-600">
				<div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
					<nav className="flex flex-wrap justify-center -mx-5 -my-2">
						...
						<div className="px-5 py-2">
							<a href="/teacher_register" className="text-base leading-6 text-gray-500 hover:text-black">
								Want be a tutor at Braiancs
							</a>
						</div>
					</nav>
					...
					<p className="mt-8 text-base leading-6 text-center text-gray-400">
						© 2024 Brainiacs, Inc. All rights reserved.
					</p>
				</div>
			</section>
		</>
